# Generated by Django 4.0.6 on 2022-08-19 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=15, max_digits=17, null=True, verbose_name='Широта')),
                ('lon', models.DecimalField(blank=True, decimal_places=14, max_digits=17, null=True, verbose_name='Долгота')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
